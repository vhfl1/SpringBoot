...
public class MainController {
	...
	public String query1() {
		User1VO user = repo.findUser1VOByUid("a1011");
	...
	public String query4() {
		List<User1VO> users = repo.findUser1VOByUidAndName("a1011", "홍길동");
		System.out.println("query4 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query5")
	public String query5() {
		List<User1VO> users = repo.findUser1VOByUidOrName("a1011", "김춘추");
	...
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(11);
		System.out.println("query7 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query8")
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(15);
		System.out.println("query8 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query9")
	public String query9() {
		List<User1VO> users = repo.findUser1VOByAgeLessThanEqual(11);
	...
	public String query18() {
		int result = repo.countUser1VOByUid("a1011");
		System.out.println("query18 결과 : "+result);
		return "redirect:/";
	}
	@GetMapping("/query19")
	public String query19() {
		int result = repo.countUSer1VOByName("김춘추");
